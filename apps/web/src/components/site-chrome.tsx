          ...
          <div className="grid gap-10 grid-cols-2 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,0.75fr)_minmax(0,1.35fr)_minmax(0,1fr)] text-[15px] text-center sm:text-left">
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="grid grid-cols-1 gap-x-6 gap-y-[9px] justify-items-center sm:grid-cols-2 sm:justify-items-start">
                <ul className="space-y-[9px]" style={{ color: bodyText }}>
                  <li><Link to="/terms-of-service" className="hover:opacity-70">Terms of Service</Link></li>
                  <li><Link to="/privacy-policy" className="hover:opacity-70">Privacy Policy</Link></li>
                  <li><Link to="/refund-policy" className="hover:opacity-70">Refund Policy</Link></li>
                </ul>
                <ul className="space-y-[9px]" style={{ color: bodyText }}>
                  <li><Link to="/income-disclaimer" className="hover:opacity-70">Income Disclaimer</Link></li>
                  <li><Link to="/affiliate-agreement" className="hover:opacity-70">Affiliate Agreement</Link></li>
                  <li><Link to="/cookie-policy" className="hover:opacity-70">Cookie Policy</Link></li>
                </ul>
              </div>
            </div>
